...
class CollisionLog:
    ...
    def get_coll_kepler(self, mc_c):
        ...
        KeplerOrbit.cart2kep(x_c_c1, y_c_c1, z_c_c1, vx_c_c1, vy_c_c1, vz_c_c1, mc_c, m1_c)
        ...
        KeplerOrbit.cart2kep(x_c_c2, y_c_c2, z_c_c2, vx_c_c2, vy_c_c2, vz_c_c2, mc_c, m2_c)
